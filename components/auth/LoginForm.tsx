  ...
  return (
    <div className="w-full max-w-md p-8 rounded-3xl bg-neutral-900/60 backdrop-blur-2xl border border-white/10 shadow-2xl relative z-10">
      ...
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-white mb-2">Vítejte zpět</h2>
        <p className="text-neutral-400 text-sm">Přihlaste se ke svému účtu a objevte ta nejlepší polední menu.</p>
      </div>
